...
import com.itnl.expotech.model.Ubication
import kotlinx.android.synthetic.main.fragment_ubicatio_detail_dialog.*
...
class UbicationDetailDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_ubicatio_detail_dialog, container, false)
    }
